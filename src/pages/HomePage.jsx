...
const HomePage = () => {
  ...
  const userReviews = [
    {
      text: "DocFind made it so easy to find a specialist near me. I booked my appointment in minutes!",
      user: "Priya, Mumbai",
    },
    {
      text: "The AI symptom checker was surprisingly accurate. It guided me to the right doctor without confusion.",
      user: "Rajesh, Delhi",
    },
    {
      text: "I loved the video consultation option, especially when I couldn’t travel. Highly recommend!",
  ...
  const handleCheckAvailability = () => {
    const cityInput = location.trim().toLowerCase();
    const specializationInput = specialization.trim().toLowerCase();

    const allDoctors = [
      { name: "Dr. Meera Shah", city: "mumbai", specialization: "cardiologist", fee: 800 },
      { name: "Dr. Rahul Iyer", city: "mumbai", specialization: "dermatologist", fee: 600 },
      { name: "Dr. Asha Menon", city: "mumbai", specialization: "gynecologist", fee: 750 },

      { name: "Dr. Vivek Gupta", city: "delhi", specialization: "orthopedic", fee: 700 },
      { name: "Dr. Neha Kapoor", city: "delhi", specialization: "pediatrician", fee: 650 },
      { name: "Dr. Anil Khurana", city: "delhi", specialization: "general physician", fee: 500 },

      { name: "Dr. Sahana Rao", city: "bangalore", specialization: "ent", fee: 600 },
      { name: "Dr. Arvind Nair", city: "bangalore", specialization: "neurologist", fee: 1200 },
      { name: "Dr. Deepa Shetty", city: "bangalore", specialization: "dentist", fee: 500 },

      { name: "Dr. Ramesh Babu", city: "chennai", specialization: "gastroenterologist", fee: 900 },
      { name: "Dr. Kavitha Subramanian", city: "chennai", specialization: "endocrinologist", fee: 850 },
      { name: "Dr. Hari Krishnan", city: "chennai", specialization: "oncologist", fee: 1500 },

      { name: "Dr. Tanmay Sen", city: "kolkata", specialization: "psychiatrist", fee: 950 },
      { name: "Dr. Moushumi Ghosh", city: "kolkata", specialization: "rheumatologist", fee: 1000 },
      { name: "Dr. Abhishek Roy", city: "kolkata", specialization: "urologist", fee: 1100 },
    ];

    const filtered = allDoctors.filter(
      (doc) =>
        doc.city === cityInput &&
        doc.specialization.toLowerCase().includes(specializationInput)
    ...
    <div className="p-6 md:p-12 space-y-8 bg-gray-50 min-h-screen">
      <section className="text-center py-14 px-4 rounded-lg shadow-md bg-gradient-to-r from-gray-800 to-gray-700 text-white">
        ...
        <p className="text-lg mb-6">
          Find top doctors & consult in-person or online seamlessly.
        </p>
        <button
          onClick={() =>
            document
              .getElementById("find-doctor-section")
      ...
      <section className="bg-white shadow-md rounded-lg p-6 space-y-4">
        ...
        <button
          ...
          className="bg-gradient-to-r from-gray-900 to-gray-800 text-white px-4 py-2 rounded"
        >
          Find Pathologies
        </button>
        <div className="space-y-2">
          {nearestLabs.map((lab, index) => (
            ...
            >
              ...
              <button
                onClick={() => sendTestRequestToLab(lab.name)}
        ...
        <div className="overflow-hidden">
          <div className="flex space-x-4 animate-scroll">
            {healthPackages.map((pkg, index) => (
              <div
                key={index}
                className="min-w-max border rounded p-4 bg-gray-100"
              >
