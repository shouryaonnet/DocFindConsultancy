    ...
    <div className="p-6 md:p-12 space-y-8 bg-gray-50 min-h-screen">
        ...
        <section className="bg-white shadow-md rounded-lg p-6 space-y-4">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <input
              ...
              onChange={(e) =>
                setFilters({ ...filters, minFee: Number(e.target.value) })
              }
            ...
            <input
              ...
              onChange={(e) =>
                setFilters({ ...filters, maxFee: Number(e.target.value) })
              }
              className="border rounded px-3 py-2"
            />
            <input
      ...
      <section className="bg-white shadow-md rounded-lg p-6 space-y-4">
        ...
        <p className="text-gray-600">
          Not sure about your condition? Let our AI assist you!
        </p>
        <button
        ...
        <div className="space-y-4">
          <div className="border rounded-lg p-4 bg-gray-50">
            <p className="text-gray-700 italic">
              "DocFind made it so easy to find a specialist near me. I booked my
              appointment in minutes!"
            </p>
            <p className="text-sm text-gray-500 mt-2">— Priya, Mumbai</p>
          </div>

          <div className="border rounded-lg p-4 bg-gray-50">
            <p className="text-gray-700 italic">
              "The AI symptom checker was surprisingly accurate. It guided me to
              the right doctor without confusion."
            </p>
            <p className="text-sm text-gray-500 mt-2">— Rajesh, Delhi</p>
          </div>

          <div className="border rounded-lg p-4 bg-gray-50">
            <p className="text-gray-700 italic">
              "I loved the video consultation option, especially when I couldn’t
              travel. Highly recommend!"
            </p>
            <p className="text-sm text-gray-500 mt-2">— Ananya, Bangalore</p>
          </div>
        </div>
      </section>
    </div>
